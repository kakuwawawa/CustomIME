...
class KeyParts {
    companion object {
        ...
        val ExclamationKey: KeyModel.InputValue = ki("!")
        val DQuotationKey: KeyModel.InputValue = ki("\"")
        val HashKey: KeyModel.InputValue = ki("#")
        val DollarKey: KeyModel.InputValue = ki("$")
        val PercentKey: KeyModel.InputValue = ki("%")
        val AndKey: KeyModel.InputValue = ki("&")
        val SQuotationKey: KeyModel.InputValue = ki("'")
        val OpenBracketKey: KeyModel.InputValue = ki("(")
        val CloseBracketKey: KeyModel.InputValue = ki(")")
        val EqualKey: KeyModel.InputValue = ki("=")
        val MinusKey: KeyModel.InputValue = ki("-")
        val CaretKey: KeyModel.InputValue = ki("^")
        val TildeKey: KeyModel.InputValue = ki("~")
        val BackSlashKey: KeyModel.InputValue = ki("\\")
        val PipeKey: KeyModel.InputValue = ki("|")
        val AtKey: KeyModel.InputValue = ki("@")
        val BacktickKey: KeyModel.InputValue = ki("`")
        val OpenSBracketKey: KeyModel.InputValue = ki("[")
        val OpenCBracketKey: KeyModel.InputValue = ki("{")
        val SemicolonKey: KeyModel.InputValue = ki(";")
        val PlusKey: KeyModel.InputValue = ki("+")
        val ColonKey: KeyModel.InputValue = ki(":")
        val AsteriskKey: KeyModel.InputValue = ki("*")
        val CloseSBracketKey: KeyModel.InputValue = ki("]")
        val CloseCBracketKey: KeyModel.InputValue = ki("}")
        val CommaKey: KeyModel.InputValue = ki(",")
        val OpenABracketKey: KeyModel.InputValue = ki("<")
        val DotKey: KeyModel.InputValue = ki(".")
        val CloseABracketKey: KeyModel.InputValue = ki(">")
        val SlashKey: KeyModel.InputValue = ki("/")
        val QuestionKey: KeyModel.InputValue = ki("?")
        val UnderbarKey: KeyModel.InputValue = ki("_")
