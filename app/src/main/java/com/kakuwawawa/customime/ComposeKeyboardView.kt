...
val NormalKeyboardData = listOf(
    listOf(ks(State.SHIFT, "shift"), ki("q"), ki("w"), ki("e"), ki("r"), ki("t"), ki("y"), ki("u"), ki("i"), ki("o"), ki("p")),
    listOf(ki("a"), ki("s"), ki("d"), ki("f"), ki("g"), ki("h"), ki("j"), ki("k"), ki("l")),
    listOf(ki("z"), ki("x"), ki("c"), ki("v"), ki("b"), ki("n"), ki("m"),sp(1f), kc(CursorDirection.LEFT, "←"), kc(CursorDirection.RIGHT, "→"))
)
